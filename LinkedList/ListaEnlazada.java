...
public class ListaEnlazada<E> implements ListaTDA<E>{ //Hereda de la clase Nodo
    ...
    public void removeNode(E nodo) throws MensajeException{
        ...
        Nodo<E> nodoEliminado = searchNodoK(posicionNodo); //nodoEliminado es el nodo en la posicion del nodo que se quiere eliminar
        Nodo<E> nodoAnterior = searchNodoK(posicionNodo-1); //El nodo anterior es el nodo anterior que apunta al nodo que se quiere eliminar
